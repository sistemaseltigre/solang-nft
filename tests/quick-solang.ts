...
describe('Simple collectible', function () {
  ...
  it('nft example', async function mint_nft() {
    ...
    const programId = new anchor.web3.PublicKey("3hnqLxpAhYvtisxRqgumwpZu8ybYggMPAf38zRwPrr9A");
    ...
    // Initialize the contract with the mint and metadata authority
    await program.methods
    .new(mint, metadata_authority.publicKey)
    .accounts({ dataAccount: storageAccount.publicKey })
    .rpc();
    
    // URI for the NFT in this case using quicknode IPFS service
